...
static struct bpf_insn test1[TEST1_SIZE] = {
  ...
  BPF_JMP_IMM(BPF_JGE, BPF_REG_0, 0, 9),
...
static struct bpf_insn test16[TEST16_SIZE] = {
  ...
  BPF_ALU64_IMM(BPF_MOV, BPF_REG_2, 7),
  BPF_ALU64_REG(BPF_ADD, BPF_REG_0, BPF_REG_1),
...
static struct bpf_insn test109[TEST109_SIZE] = {
  ...
  BPF_STX_XADD(64, BPF_REG_0, BPF_REG_1, 8),
  BPF_JMP_A(8),
  BPF_JMP_IMM(BPF_JEQ, BPF_REG_0, 128, 160),
  BPF_JMP_REG(BPF_JEQ, BPF_REG_0, BPF_REG_1, 160),
  BPF_JMP_IMM(BPF_JGT, BPF_REG_0, 128, 160),
  BPF_JMP_REG(BPF_JGT, BPF_REG_0, BPF_REG_1, 160),
  BPF_JMP_IMM(BPF_JGE, BPF_REG_0, 128, 160),
  BPF_JMP_REG(BPF_JGE, BPF_REG_0, BPF_REG_1, 160),
  BPF_JMP_IMM(BPF_JLT, BPF_REG_0, 128, 160),
  BPF_JMP_REG(BPF_JLT, BPF_REG_0, BPF_REG_1, 160),
  BPF_JMP_IMM(BPF_JLE, BPF_REG_0, 128, 160),
  BPF_JMP_REG(BPF_JLE, BPF_REG_0, BPF_REG_1, 160),
  BPF_JMP_IMM(BPF_JSET, BPF_REG_0, 128, 160),
  BPF_JMP_REG(BPF_JSET, BPF_REG_0, BPF_REG_1, 160),
  BPF_JMP_IMM(BPF_JNE, BPF_REG_0, 128, 160),
  BPF_JMP_REG(BPF_JNE, BPF_REG_0, BPF_REG_1, 160),
  BPF_JMP_IMM(BPF_JSGT, BPF_REG_0, 128, 160),
  BPF_JMP_REG(BPF_JSGT, BPF_REG_0, BPF_REG_1, 160),
  BPF_JMP_IMM(BPF_JSGE, BPF_REG_0, 128, 160),
  BPF_JMP_REG(BPF_JSGE, BPF_REG_0, BPF_REG_1, 160),
  BPF_JMP_IMM(BPF_JSLT, BPF_REG_0, 128, 160),
  BPF_JMP_REG(BPF_JSLT, BPF_REG_0, BPF_REG_1, 160),
  BPF_JMP_IMM(BPF_JSLE, BPF_REG_0, 128, 160),
  BPF_JMP_REG(BPF_JSLE, BPF_REG_0, BPF_REG_1, 160),
  BPF_CALL_REL(44),
  BPF_JMP32_IMM(BPF_JEQ, BPF_REG_0, 128, 160),
  BPF_JMP32_REG(BPF_JEQ, BPF_REG_0, BPF_REG_1, 160),
  BPF_JMP32_IMM(BPF_JGT, BPF_REG_0, 128, 160),
  BPF_JMP32_REG(BPF_JGT, BPF_REG_0, BPF_REG_1, 160),
  BPF_JMP32_IMM(BPF_JGE, BPF_REG_0, 128, 160),
  BPF_JMP32_REG(BPF_JGE, BPF_REG_0, BPF_REG_1, 160),
  BPF_JMP32_IMM(BPF_JLT, BPF_REG_0, 128, 160),
  BPF_JMP32_REG(BPF_JLT, BPF_REG_0, BPF_REG_1, 160),
  BPF_JMP32_IMM(BPF_JLE, BPF_REG_0, 128, 160),
  BPF_JMP32_REG(BPF_JLE, BPF_REG_0, BPF_REG_1, 160),
  BPF_JMP32_IMM(BPF_JSET, BPF_REG_0, 128, 160),
  BPF_JMP32_REG(BPF_JSET, BPF_REG_0, BPF_REG_1, 160),
  BPF_JMP32_IMM(BPF_JNE, BPF_REG_0, 128, 160),
  BPF_JMP32_REG(BPF_JNE, BPF_REG_0, BPF_REG_1, 160),
  BPF_JMP32_IMM(BPF_JSGT, BPF_REG_0, 128, 160),
  BPF_JMP32_REG(BPF_JSGT, BPF_REG_0, BPF_REG_1, 160),
  BPF_JMP32_IMM(BPF_JSGE, BPF_REG_0, 128, 160),
  BPF_JMP32_REG(BPF_JSGE, BPF_REG_0, BPF_REG_1, 160),
  BPF_JMP32_IMM(BPF_JSLT, BPF_REG_0, 128, 160),
  BPF_JMP32_REG(BPF_JSLT, BPF_REG_0, BPF_REG_1, 160),
  BPF_JMP32_IMM(BPF_JSLE, BPF_REG_0, 128, 160),
  BPF_JMP32_REG(BPF_JSLE, BPF_REG_0, BPF_REG_1, 160),
  BPF_ZEXT_REG(BPF_REG_0),
  BPF_EXIT_INSN(),
};
